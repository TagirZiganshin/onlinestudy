...
<div class="flex justify-center items-center relative top-20">
  <div class="w-96 p-6 border border-gray-300 rounded-md bg-white">
    <h2 class="text-center text-2xl mb-6">Изменить пароль</h2>
    <form action="{{ route('changePassword.update') }}" method="POST">
      ...
      <!-- Current Password -->
      <div class="mb-4">
        <label for="current_password" class="block font-bold text-gray-700">Текущий праоль</label>
      ...
      <!-- New Password -->
      <div class="mb-4">
        <label for="new_password" class="block font-bold text-gray-700">Новый пароль</label>
      ...
      <div class="mb-4">
        <label for="new_password_confirmation" class="block font-bold text-gray-700">Подтвердите пароль</label>
        <input type="password" id="new_password_confirmation" name="new_password_confirmation" class="form-input mt-1 block w-full">
      </div>
      <!-- Update Password Button -->
      <div>
        <button type="submit" class="w-full py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Изменить пароль</button>
      </div>
    </form>
  </div>
</div>
