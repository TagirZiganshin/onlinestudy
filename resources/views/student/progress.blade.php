    ...
    <table id="student1" class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th scope="col" class="px-6 py-4 font-large text-gray-900">Прогресс</th>
                <th scope="col" class="px-6 py-4 font-large text-gray-900">Оценка</th>
                <th scope="col" class="px-6 py-4 font-large text-gray-900">Финальная оценка</th>
                <th scope="col" class="px-6 py-4 font-large text-gray-900">Язык</th>
            </tr>
        </thead>
