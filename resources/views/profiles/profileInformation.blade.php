...
<div class="flex justify-center items-center relative top-20">
  <div class="w-96 p-6 bg-white rounded-lg shadow-md">
    <h1 class="text-2xl font-semibold mb-6 text-center">Параметры профиля</h1>
    <form action="{{ route('profileInformation.update') }}" method="POST">
      ...
      <!-- First Name -->
      <div class="mb-4">
        <label for="first_name" class="block font-bold text-gray-700">Фамилия</label>
      ...
      <!-- Last Name -->
      <div class="mb-4">
        <label for="last_name" class="block font-bold text-gray-700">Имя</label>
      ...
      <!-- Email Address -->
      <div class="mb-4">
        <label for="email" class="block font-bold text-gray-700">Почта</label>
        <input type="email" id="email" name="email" value="{{ old('email', $user->email) }}" class="form-input mt-1 block w-full">
      </div>
      <!-- Address -->
      <div class="mb-4">
        <label for="address" class="block font-bold text-gray-700">Адрес</label>
      ...
      <!-- Phone Number -->
      <div class="mb-4">
        <label for="phone_number" class="block font-bold text-gray-700">Телефон</label>
      ...
      <div>
        <button type="submit" class="w-full py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Обновить профиль</button>
      </div>
    </form>
  </div>
</div>
